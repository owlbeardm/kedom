    ...
    [
        {
            ...
            "suboptions": [{
                ...
                "toRoll": 3,
                "name": "Нитолец",
                "foci": "Add one Expert Focus",
                "description": `
                    <h3>Люди</h3>
                    <p>Из всех цивилизованных существ, люди встречаются чаще всего по всему миру. Возможно, их фантастическая способность к адаптации помогает в этом.</p>
                    ...
                    <p>Нитольцев можно встретить по всему миру. Часто, они бегут в другие земли от проблем, долгов или просто скуки. И они довольно быстро приживаются в новых местах.</p>
                    <p>Темноволосые, экспрессивные индивидуалисты. Другие культуры считают их резкими, самодостаточными, эгоистичными.</p>
                    <h3>Foci</h3>
                ...
                "description": `
                    <h3>Люди</h3>
                    <p>Из всех цивилизованных существ, люди встречаются чаще всего по всему миру. Возможно, их фантастическая способность к адаптации помогает в этом.</p>
                    <h4 id="сарольцы-фероры" tabindex="-1"><a class="header-anchor" href="#сарольцы-фероры"><span>Фероры (Сарольцы)</span></a></h4>
                    ...
                    <p>Фероры — загадочные южане с длинными именами и яркой одеждой родом из земель по ту сторону внутренних морей. Немногие решаются путешествовать через пустыни и оказываются в чужих землях.</p>
                    <p>Фероры практикуют загадочные для других магические ритуалы и верования, оставаясь закрытой группой. Информации о них почти не проникает за пределы общин. Другие культуры считают их формальными, вежливыми, скрытными, склонными к манипуляциям.</p>
                    <h3>Foci</h3>
                    <p>Люди получают дополнительный Expert Focus.</p></div>
                `,
            }, {
                ...
                "description": `
                    ...
                    <div class="div-with-image"><img alt="Нерланцы" src="/img/ancestry/nerland.webp" align="right" class="anc-img" photo-swipe="" style="cursor: zoom-in;"><p>Нерланцы — могучие дикари с севера. Они отгорожены от южных земель горами и появляются там не так часто.</p><p>Физически грубые, сильные они принимаются за самые разные сложные работы. Часто среди них встречаются отличные ремесленники, многие работают кузнецами или плотниками. Но ещё их можно встретить с оружием в руках.</p><p>Нерланцев можно узнать по высокому росту, светлым волосам и коже, простой одежде, грубом акценте. Другие культуры считают их простыми, прямыми, преданными долгу. Как и дварфы они ценят договоры, поэтому и те и другие высокого мнения друг о друге.</p></div>
                    <h3>Foci</h3>
                    <p>Люди получают дополнительный Expert Focus.</p></div>
                `,
            }, {
                ...
                "description": `
                    ...
                    <p>Из всех цивилизованных существ, люди встречаются чаще всего по всему миру. Возможно, их фантастическая способность к адаптации помогает в этом.</p>
                    <h4>Полуэльф</h4>
                    <div class="div-with-image"><img alt="Полуэльф" src="/img/ancestry/half-elf.webp" align="right" class="anc-img" photo-swipe="" style="cursor: zoom-in;"><p>Альвы — загадочные, непоследовательные хаотичные создания леса. Поселяясь рядом с людьми, они нападают на них в лесах, крадут их скот, а иногда и детей (превращая их в полуэльфов забывших о своих родных).</p><p>Люди часто отвергают вернувшихся детей, и тем тяжело найти своё место в мире. Гонимые обществом они пытаются найти себе задание или прибежище.</p><p>Другие культуры считают их коварными и хаотичными, большинство опасается их не зная чего ожидать.</p></div>
                    <h3>Foci</h3>
                    <p>Люди получают дополнительный Expert Focus.</p></div>
                `,
            }, {
                ...
                "description": `
                    ...
                    <p>Из всех цивилизованных существ, люди встречаются чаще всего по всему миру. Возможно, их фантастическая способность к адаптации помогает в этом.</p>
                    <h4>Полуорк</h4>
                    <div class="div-with-image"><img alt="Полуорк" src="/img/ancestry/half-orc.webp" align="right" class="anc-img" photo-swipe="" style="cursor: zoom-in;"><p>Иногда магия прошлых веков дремлет в крови людей. И, бывает, она просыпается в ком-то через много столетий. Но это нельзя назвать благословением, часто этот человек не знает, как управлять этой древней силой, и он только основывает все вокруг него. Таких людей называют полуорками, хотя с этими орками они похожи только на масштабы разрушения и свирепости, подкармливание магии прошлого.</p><p>Их последствия, чтобы избежать и проклятия, которые они несут с собой. Другие культуры считают их опасными, дикими. И проклятые полуорки стоят одни во тьме забытого мира.</p></div>
                    <h3>Foci</h3>
                    <p>Люди получают дополнительный Expert Focus.</p></div>
                `,
            }],
